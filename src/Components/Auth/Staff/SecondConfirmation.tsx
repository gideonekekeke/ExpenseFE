...
const SecondConfirmation: React.FC = () => {
  const { id } = useParams();
    ...
    <Container>
      <Wrapper>
        <Card>
          ...
          <Title>
            <TitleHead>Please be patient</TitleHead>
            <br />
            <TitleSub>
              An Email has been sent to you <span>BOSS</span> for the
              confirmation of your account... once your BOSS has confirm and
              authenticate your account, your account will now be verified{" "}
              <span>You can follow </span>on your BOSS to speeden the process!
              <br />
              <br />
